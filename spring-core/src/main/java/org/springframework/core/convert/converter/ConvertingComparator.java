 ...
 * {@code Comparator}.
 * <p>
 * 在进行比较之前，先通过{@link Converter}将需要比较的两个值转换为需要的类型，然后再通过{@link Comparator}进行比较
 * </p>
 *
...
public class ConvertingComparator<S, T> implements Comparator<S> {
     ...
     *
     * <p>
     * 聚合{@link ConversionService} 和targetType到一个{@link Converter},通过{@link ConversionService}进行类型的转换
     * </p>
     */
