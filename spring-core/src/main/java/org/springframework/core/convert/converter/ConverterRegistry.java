 ...
 *
 * <p>
 * 转换器的注册接口，用于注册{@code converters}，形成一个转换系统
 * </p>
 *
 * @author Keith Donald
...
public interface ConverterRegistry {
     ...
     * The convertible sourceType/targetType pair is derived(衍生) from the Converter's parameterized types.
     *
     * <p>
     * 添加一个转换器到当前registry,能够转换的源/目标对的类型，根据{@link Converter}的具体参数类型来确定
     * </p>
     *
     ...
     * <p>
     * 添加一个转换器到当前的registry
     * 明确的指定sourceType/targetType对，能够让{@link Converter}重用，用于处理相同的源/目标对
     * </p>
     *
     * @since 3.1
     */
