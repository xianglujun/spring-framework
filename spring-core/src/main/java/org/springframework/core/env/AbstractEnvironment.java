 ...
 * reserved(保留的) default profile names and enables specifying active and default profiles
...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
    ...
    /**
     * System property that instructs(命令) Spring to ignore system environment variables,
     * i.e. to never attempt to retrieve(检索) such a variable via {@link System#getenv()}.
     ...
     * delimited(该配置的值，可能存在多个，采用,进行分割).
     ...
     * automatically be activated(使激活) by default.
     *
    ...
    /**
     * 用于获取或者配置的属性值，以及{@link org.springframework.core.convert.ConversionService}相关服务的配置。
     */
     ...
     * allow subclasses to contribute(贡献) or manipulate {@link PropertySource} instances as
     * appropriate(适当的).
     *
