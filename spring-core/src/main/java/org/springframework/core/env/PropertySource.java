 ...
 * {@linkplain #getSource() source object} may be of any type {@code T} that encapsulates(压缩)
 ...
 * precedence-based searches across the set of {@code PropertySources}.</p>
 * <br/>
 ...
 * as well as the {@link #named(String)} and {@link #toString()} methods for details.</p>
 *
